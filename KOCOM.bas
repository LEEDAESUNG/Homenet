...
End With
    ...
    If FrmKocom.HomeSock.State = 7 Then
        With KHeader     '헤더전송
            FrmKocom.HomeSock.SendData .KEY()
            FrmKocom.HomeSock.SendData .MSGTYPE()
            FrmKocom.HomeSock.SendData .MSGLENGTH()
            FrmKocom.HomeSock.SendData .TOWN()
            FrmKocom.HomeSock.SendData .Dong()
            FrmKocom.HomeSock.SendData .Ho()
            FrmKocom.HomeSock.SendData .Reserved()
        End With
        With KAlive
            FrmKocom.HomeSock.SendData .HomeVersion()
            FrmKocom.HomeSock.SendData .nKind()
            FrmKocom.HomeSock.SendData .nVersion()
        End With
    Else
        Kocom_Mode = ""
...
End With
    ...
    If FrmKocom.HomeSock.State = 7 Then
        ...
        End With
        With KInfo
            FrmKocom.HomeSock.SendData .szGateId()
            FrmKocom.HomeSock.SendData .szParkMan()
            FrmKocom.HomeSock.SendData .szCardNo()
            FrmKocom.HomeSock.SendData .nInOut()
            FrmKocom.HomeSock.SendData .szDate()
            FrmKocom.HomeSock.SendData .szCarNo()
        End With
...
With FrmKocom
    ...
    Call HomeLogger("[HomeSock_Connection]" & " HomeNet_IP : " & HomeNet_IP & " HomeNet_Port : " & HomeNet_Port)
End With

Exit Sub

Err_P:
    Call HomeLogger("[HomeSock_Connect Proc] 에러내용 : " & Err.Description)
