...
Begin VB.Form FrmHyundae 
   BorderStyle     =   1  '단일 고정
   Caption         =   "현대통신 홈넷 프로그램(윈도우)"
   ClientHeight    =   6990
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   17430
   ...
   Begin VB.ListBox List1 
      ...
      ForeColor       =   &H00E0E0E0&
      Height          =   4560
      ItemData        =   "FrmHyundae.frx":0000
      Left            =   120
      List            =   "FrmHyundae.frx":0002
      TabIndex        =   0
      Top             =   1710
      Width           =   17220
   End
...
On Error GoTo Err_P
    ...
    '현대통신 세대통보
    Call HyunDaeCom_Proc(HomeNet_Dong, HomeNet_Ho, HomeNet_CarNo)
...
Public Sub HyunDaeCom_Proc(Dong As String, Ho As String, CarNo As String)
...
Call HomeLogger("[HyunDaeCom_Proc]  SND : " & Socket_Data)
...
Err_Proc:
    Call HomeLogger("[HyunDaeCom_Proc]  " & Err.Description)
End Sub
...
Call HomeLogger("[HyunDaeCom_Proc]  RCV : " & rMsg)
...
Err_P:
    Call HomeLogger(" [HyunDaeCom_Proc RCV] 에러내용 : " & Err.Description)
End Sub
